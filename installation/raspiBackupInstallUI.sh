...
MSG_EN[$DESCRIPTION_STARTSTOP_SEQUENCE]="${NL}Select sequentially which important services should be stopped. \
Actual sequence is displayed top down. \
For further details see https://www.linux-tips-and-tricks.de/en/faq#a18."
MSG_DE[$DESCRIPTION_STARTSTOP_SEQUENCE]="${NL}Wähle die Services in der Reihe aus wie sie vor dem Backup gestoppt werden sollen. \
